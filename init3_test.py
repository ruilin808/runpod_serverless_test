...
class ResourceCallback(TrainerCallback):
    ...
    def __init__(self, logger, teds_evaluator=None, eval_dataset=None):
        self.logger = logger
        # self.teds_evaluator = teds_evaluator  # COMMENTED OUT
        # self.eval_dataset = eval_dataset      # COMMENTED OUT
    ...
    def on_evaluate(self, args, state, control, logs=None, **kwargs):
        """Run TEDS evaluation after training evaluation - COMMENTED OUT"""
...
def main():
    ...
    template = get_template(model.model_meta.template, processor, max_length=21000)  # Reduced from 32768
    ...
    trainer = Seq2SeqTrainer(
        ...
        template=template,
        callbacks=[ResourceCallback(logger)],  # Removed TEDS parameters
    )
    
    trainer.train()
    
    # Final evaluation - COMMENTED OUT
